...
class LogTrainingDynamics(Callback):
    ...
    def on_train_batch_end(
        ...
        self.train_logits.append(outputs['output'])
        self.train_labels.append(outputs['y'])
    ...
    def on_train_epoch_end(self, trainer: Trainer,
        ...
        with self.save_dir.joinpath(
                f'dynamics_epoch_{trainer.current_epoch}.jsonl').open(
                    mode='w') as f:
