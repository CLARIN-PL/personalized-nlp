...
from personalized_nlp.datasets.cockamamie_gobbledegook.cockamamie_gobbledegook_majority import (
    CockamamieGobbledegookMajorityDataModule)
...
if __name__ == "__main__":
    ...
    datamodule_cls = CockamamieGobbledegookMajorityDataModule
