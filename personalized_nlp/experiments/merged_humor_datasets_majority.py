...
from personalized_nlp.datasets.merged_humor_datasets.merged_humor_datasets_majority import (
    MergedHumorDatasetsMajorityDataModule)
...
if __name__ == "__main__":
    ...
    datamodule_cls = MergedHumorDatasetsMajorityDataModule
