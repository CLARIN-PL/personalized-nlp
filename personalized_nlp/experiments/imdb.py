...
from personalized_nlp.datasets.imdb import ImdbDataModule
...
if __name__ == "__main__":
    wandb_project_name = "2022_wein_icdmw_kk_temp"
    datamodule_cls = ImdbDataModule
    ...
    datamodule_kwargs_list = product_kwargs({
        ...
        "folds_num": [1],
        "batch_size": [25],  # [25] for UserId model, [32] otherwise
    ...
    trainer_kwargs_list = product_kwargs({
        ...
        "lr": [0.00005],  # [0.00005] for UserId model, [0.008] otherwise
        # "auto_lr_find": [True],
        "regression": [False],
        "use_cuda": [True],  # False
        "model_type": [
        ...
        "monitor_metric": ["valid_accuracy_sentiment"],
        "monitor_mode": ["max"],
    })
