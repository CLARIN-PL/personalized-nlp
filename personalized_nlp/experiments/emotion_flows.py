...
from personalized_nlp.datasets.emotions import EmotionsCollocationsDatamodule #EmotionsSimpleDataModule
...
if __name__ == "__main__":
    ...
    datamodule_cls = EmotionsCollocationsDatamodule  # ClarinEmoSentNoNoiseDataModule
