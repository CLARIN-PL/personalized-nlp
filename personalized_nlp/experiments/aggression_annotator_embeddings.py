...
if __name__ == "__main__":
    wandb_project_name = "AggressionAnnotatorEmbeddings"
    ...
    trainer_kwargs_list = product_kwargs(
        {
            ...
            "model_type": ["annotator_mean_text_embeddings", "baseline", "peb", "bias"],
        }
    )
    ...
    for datamodule_kwargs in datamodule_kwargs_list:
        ...
        for model_kwargs, trainer_kwargs in product(
            ...
            ] = data_module.annotator_mean_text_embeddings.shape[1]
            hparams = {
