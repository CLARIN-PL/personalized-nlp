...
from personalized_nlp.datasets.semeval2020.semeval2020 import SemevalDataModule
...
if __name__ == '__main__':
    ...
    for embeddings_type in ['xlmr', 'bert', 'deberta', 'labse', 'mpnet', 'random']:
        ...
        for model_type in ['onehot', 'baseline', 'peb', 'bias', 'embedding', 'word_embedding']:
            for embedding_dim in [50]:
                for fold_num in range(4):
                    ...
                    logger = pl_loggers.WandbLogger(
                        save_dir=LOGS_DIR, config=hparams, project='semeval2020_folds',
                        log_model=False)
                    ...
                    train_test(data_module, model, epochs=50, lr=0.001, regression=regression,
