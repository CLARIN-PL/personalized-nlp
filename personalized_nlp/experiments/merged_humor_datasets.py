...
from personalized_nlp.datasets.merged_humor_datasets.merged_humor_datasets import (
    MergedHumorDatasetsDataModule)
...
if __name__ == "__main__":
    ...
    datamodule_cls = MergedHumorDatasetsDataModule
