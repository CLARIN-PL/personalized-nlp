...
from personalized_nlp.datasets.merged_humor_datasets_personalized.merged_humor_datasets_personalized import (
    MergedHumorDatasetsPersonalizedDataModule)
...
if __name__ == "__main__":
    wandb_project_name = "MergedHumorDatasetsPersonalizedNewArchs"
